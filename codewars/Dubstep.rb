def song_decoder(song)
  array_song_word = []
  song.split('WUB').each do |i|
    if i != ''
      array_song_word.push(i)
    end
  end
  array_song_word.join(' ')
end
...
# this song, Polycarpus inserts a certain number of words "WUB" before the first word of the song (the number may be zero),
